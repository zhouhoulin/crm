					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>拜访时间：</td>
								<td>
									<s:textfield readonly="true" id="visitTime" cssClass="textbox" cssStyle="WIDTH: 180px" name="visitTime" />
								</td>
								<td>拜访地点 ：</td>
								<td>
								<s:textfield cssClass="textbox" id="sChannel2" cssStyle="WIDTH: 180px" maxlength="50" name="visitAddr"/>
								</td>
							</TR>
							<TR>
								<td>拜访详情 ：</td>
								<td>
								<s:textfield cssClass="textbox" id="sChannel2" cssStyle="WIDTH: 180px" maxlength="50" name="visitDetail"/>
								</td>
								<td>下次拜访时间 ：</td>
								<td>
								<s:textfield readonly="true" id="visitNexttime" cssClass="textbox" cssStyle="WIDTH: 180px" maxlength="50" name="visitNexttime"/>
								</td>
							</TR>
							<tr>
								<td rowspan=2>
