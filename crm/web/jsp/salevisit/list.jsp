...
<script type="text/javascript">
	$(function(){
		...
		$('#visitEndtime').datepick({dateFormat: 'yy-mm-dd'});
	});
</script>
...
<FORM id="customerForm" name="customerForm"
	  action="${pageContext.request.contextPath }/saleVisit_findAll.action" method=post>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>拜访时间：从</TD>
													<TD>
													<input type="text" id="visitTime" name="visitTime" readonly="readonly" value="<s:date name="visitTime" format="yyyy-MM-dd"/>"/>
													</TD>
													<TD>到</TD>
													<TD>
													<input type="text" id="visitEndtime" name="visitEndtime" readonly="readonly" value="<s:date name="visitEndtime" format="yyyy-MM-dd"/>"/>
													</TD>
